...
async function main() {
  const beneficiary = "0xa0Ee7A142d267C1f36714E4a8F75612F20a79720"; // Metaverse Acquisition Vault address
  ...
  console.log("Metaverse Acquisition Vault VestingWallet deployed at:", vestingWallet.address);
  ...
  await tx.wait();
  console.log(`Transferred ${ethers.utils.formatUnits(amount, 18)} NTK to Metaverse Acquisition Vault vesting wallet.`);
}
