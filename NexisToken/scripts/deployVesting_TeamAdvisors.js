...
async function main() {
  const beneficiary = "0x90F79bf6EB2c4f870365E785982E1f101E93b906"; // Team & Advisors address
  ...
  console.log("Team & Advisors VestingWallet deployed at:", vestingWallet.address);
  ...
  await tx.wait();
  console.log(`Transferred ${ethers.utils.formatUnits(amount, 18)} NTK to Team & Advisors vesting wallet.`);
}
